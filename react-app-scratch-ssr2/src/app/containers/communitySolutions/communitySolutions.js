...
const communitySolutions = () => {
    ...
    <div id="ini" className="block-1">
        <div>
          ...
          <span>
            Podemos ayudarte <strong>instalando c&aacute;maras de seguridad</strong> en tu casa, lo hacemos por un bajo costo y de forma r&aacute;pida. Ll&aacute;manos a nuestro movil y te atenderemos inmediatamente.
          </span>
        </div>
    </div>
